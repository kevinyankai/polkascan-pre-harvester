...
DB_HOST = os.environ.get("DB_HOST", "103.224.250.19")
...
CELERY_BROKER=os.environ.get("CELERY_BROKER", "redis://103.224.250.19:6379/0")
CELERY_BACKEND=os.environ.get("CELERY_BACKEND", "redis://103.224.250.19:6379/1")
...
SUBSTRATE_RPC_URL = os.environ.get("SUBSTRATE_RPC_URL", "ws://103.224.250.19:39003/")
...
SUBSTRATE_STORAGE_INDICES = os.environ.get("SUBSTRATE_STORAGE_INDICES", "Accounts")
